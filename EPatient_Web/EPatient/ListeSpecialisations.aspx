<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ListeSpecialisations.aspx.vb" Inherits="EPatient_Web.ListeSpecialisations" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <li class="active">Liste des spécialisations</li>
</ol>
				</div> 
      ...
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">Nouvelle spécialisation</button>
                      </div>
           ...
           <tbody>
            ...
            <ItemTemplate>
                 <tr>
                    ...
                    <asp:TextBox Visible="false" runat="server" ID="TextBox2" Text='<%#Eval("ID_Specialisation")%>'></asp:TextBox>
                  ...
                  <asp:TextBox Visible="false" runat="server" ID="TextBox2" Text='<%#Eval("ID_Fonction")%>'></asp:TextBox>--%>
                                        ...
                                        <tr>
                                            ...
                                            <td><asp:TextBox ID="tb_update_lon_piege" CssClass="form-control" runat="server" Text='<%# Bind("Description")%>'></asp:TextBox></td>
                                             <td><asp:TextBox ID="txt_update_code" CssClass="form-control" runat="server" Text='<%# Bind("codeSpecialisation")%>'></asp:TextBox></td>
                    ...
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel2">Ajouter spécialisation</h4>
                        </div>
                        <div class="modal-body">
                        <div class="form-group">
                            
              <label for="recipient-name" class="form-control-label">Nom spécialisation </label>
             <asp:TextBox runat="server" id="txt_specialisation" class="form-control col-md-7 col-xs-12" name="recipient-name" placeholder="entrez le secteur" required="required" type="text"></asp:TextBox>
