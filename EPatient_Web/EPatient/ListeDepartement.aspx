<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ListeDepartement.aspx.vb" Inherits="EPatient_Web.ListeDepartement" %>
      ...
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">Nouveau département</button>
           ...
           <tbody>
            ...
            <ItemTemplate>
             ...
             <asp:TextBox runat="server" id="txt_libelle" class="form-control col-md-7 col-xs-12" name="recipient-name" placeholder="entrez le secteur" required="required" type="text"></asp:TextBox>
