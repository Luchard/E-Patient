<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ListePatients.aspx.vb" Inherits="EPatient_Web.ListePatients" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <a href="../production/dashboard.aspx">Home</a></li>
  <li class="active">Liste des patients</li>
      ...
      <asp:button runat="server"  class="btn btn-primary" ID ="btnew" Text="Nouveau patient"></asp:button>
                      </div>
