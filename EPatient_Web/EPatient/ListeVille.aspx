<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ListeVille.aspx.vb" Inherits="EPatient_Web.ListeVille" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <li class="active">Liste des villes</li>
      ...
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">Nouvelle ville</button>
                      </div>
           ...
           <tbody>
            ...
            <ItemTemplate>
                 <tr>
                          <td><%#Eval("Libelle")%></td>
                     <td><%#Eval("libelle_departement")%></td>
                    ...
                    <asp:TextBox Visible="false" runat="server" ID="TextBox2" Text='<%#Eval("ID_Ville")%>'></asp:TextBox>
                  ...
                  <asp:TextBox Visible="false" runat="server" ID="TextBox2" Text='<%#Eval("ID_Fonction")%>'></asp:TextBox>--%>
                                        ...
                                        <tr>
                                            ...
                                            <td><asp:TextBox ID="tb_update_lon_piege" CssClass="form-control" runat="server" Text='<%# Bind("Libelle")%>'></asp:TextBox></td>
                                             ...
                                             <asp:TextBox Visible="false" runat="server" ID="TextBox1" Text='<%#Eval("ID_Ville")%>'></asp:TextBox>
                                             <td>
                    ...
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel2">Ajouter institution</h4>
                        </div>
                        <div class="modal-body">
                        <div class="form-group">
                            
              <label for="recipient-name" class="form-control-label">Nom ville </label>
             <asp:TextBox runat="server" id="txt_fonction" class="form-control col-md-7 col-xs-12" name="recipient-name" placeholder="entrez la ville" required="required" type="text"></asp:TextBox>
           ...
           <asp:DropDownList runat="server" ID ="ddl_departement" class="form-control col-md-7 col-xs-12"></asp:DropDownList>
                              </div>
