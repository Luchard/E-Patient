<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ListeInstitution.aspx.vb" Inherits="EPatient_Web.ListeInstitution" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <li class="active">Liste des institutions</li>
</ol>
				</div> 
      ...
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-sm">Nouvelle institution</button>
                      </div>
           ...
           <tbody>
            ...
            <ItemTemplate>
                 <tr>
                    ...
                    <asp:TextBox Visible="false" runat="server" ID="TextBox2" Text='<%#Eval("ID_Institution")%>'></asp:TextBox>
                  ...
                  <asp:TextBox Visible="false" runat="server" ID="TextBox2" Text='<%#Eval("ID_Fonction")%>'></asp:TextBox>--%>
                                        ...
                                        <tr>
                                            ...
                                            <td><asp:TextBox ID="tb_update_lon_piege" CssClass="form-control" runat="server" Text='<%# Bind("Nom")%>'></asp:TextBox></td>
                                             
                                            
                                             <asp:TextBox Visible="false" runat="server" ID="TextBox1" Text='<%#Eval("ID_Institution")%>'></asp:TextBox>
                                             <td>
              ...
              <label for="recipient-name" class="form-control-label">Nom institution </label>
