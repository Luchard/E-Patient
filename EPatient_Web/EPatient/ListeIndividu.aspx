<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ListeIndividu.aspx.vb" Inherits="EPatient_Web.ListeIndividu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <a href="../production/dashboard.aspx">Home</a></li>
  <li class="active">Liste des médecins</li>
      ...
      <asp:button runat="server"  class="btn btn-primary" ID ="btnew" Text="Nouvel individu"></asp:button>
                      </div>
           ...
           <tbody>
            ...
            <ItemTemplate>
                 <tr>
                      <td><a href="../EPatient/AddIndividu.aspx?ID_Individu=<%#Eval("ID_Individu")%>"><%#Eval("ID_Individu")%></a></td>  
