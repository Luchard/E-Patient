<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ListePrescriptions.aspx.vb" Inherits="EPatient_Web.ListePrescriptions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <a href="../production/dashboard.aspx">Home</a></li>
  <li class="active">Liste des prescriptions</li>
</ol>
				</div> 
              <div class="page-title">
              <div class="title_left">
                 <div class="col-md-12" style="font-size: 20px;">
        GESTIONS DES PRESCRIPTIONS
			      </div>
              </div>
            ...
            <div class="clearfix"></div>
                  ...
                  <div class="row alignright"  style="margin-right: 15px;">
                      ...
                      <asp:button runat="server"   class="btn btn-primary" ID="btn_new"  Text="Nouvelle prescription"></asp:button> 
                  </div>
           ...
           <tbody>
            ...
            <ItemTemplate>
                 <tr>
                      ...
                      <td><a href="../EPatient/EditerPrescription.aspx?ID_Prescription=<%#Eval("ID_Prescription")%>"><%#Eval("ID_Prescription")%></a></td>  
                          <td><a href="../EPatient/ListeMedicaments.aspx?ID=<%#Eval("ID_Prescription")%>"><%#Eval("nom_complet_patient")%></a></td>
                     <td><a href="../EPatient/ListeMedicaments.aspx?ID=<%#Eval("ID_Prescription")%>"><%#Eval("nom_complet_medecin")%></a></td>
                            <td><%#Eval("DescriptionDiagnostique")%></td>
                     <td><%#Eval("DescriptionSymptome")%></td>
                     <td><%#Eval("DateAusculte")%></td>
                       <%-- 
                  ...
                  <asp:TextBox Visible="false" runat="server" ID="TextBox2" Text='<%#Eval("ID_Fonction")%>'></asp:TextBox>--%>
                      <asp:TextBox Visible="false" runat="server" ID="TextBox2" Text='<%#Eval("ID_Prescription")%>'></asp:TextBox>  
                      </tr>
               </ItemTemplate>
                                                     <EditItemTemplate>
                                        <tr>
                                            ...
                                            <td><asp:TextBox ID="tb_update_lon_piege" CssClass="form-control" runat="server" Text='<%# Bind("ID_Prescription")%>'></asp:TextBox></td>
                                             
                                            
                                             <asp:TextBox Visible="false" runat="server" ID="TextBox1" Text='<%#Eval("ID_Prescription")%>'></asp:TextBox>
                                             <td>
